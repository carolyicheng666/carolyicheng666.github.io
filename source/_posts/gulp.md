...
<blockquote class="blockquote-center">员工离职，只有两个真实原因：钱没给到位；心受委屈了
<strong>马云</strong>
</blockquote>
...
我觉得 [这篇对比介绍](http://slides.com/contra/gulp#/) 写的很好，大家可以看看。其中作者提到了为什么 `grunt` 不好的原因：
...
这一点我也表示赞同，不过还是看个人喜好吧，这里不做过多讨论。下面才是本文的重点，都是目前我用过的插件，持续更新...
...
**注意**，虽然 [官方文档的Example](https://www.npmjs.com/package/gulp-uncss) 中使用了 `gulp-cssnano` 插件压缩css，但是相比较于 `gulp-clean-css` 效果较差，故不推荐使用
...
不过从结果来看，依然比不过强大的 [tinypng](https://tinypng.com/) ，如果对压缩的需求不是特别大，或者觉得手动 `tinypng` 太麻烦的话，就凑合着用吧，hiahia~
...
关于在 `gulp` 中的搭建方式建议看 **[这里](https://browsersync.io/docs/gulp)**
